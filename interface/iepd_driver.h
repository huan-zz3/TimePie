...
public:
    ...
    */
    virtual void epdriver_Init(Result<void>) = 0;
    virtual void epdriver_Clear(Result<void>, ClearMode) = 0;
    virtual void epdriver_Display(Result<void>, DisplayMode) = 0;
    ...
    */
    ...
    virtual void epdriver_DrawRectangle(Result<void>, ImageBuffer, PointCoordinates, PointCoordinates, ImageColor, PointSize, LineStyle) = 0;
    virtual void epdriver_DrawCircle(Result<void>, ImageBuffer, PointCoordinates, RaiusLength, ImageColor, PointSize, LineStyle) = 0;

    virtual void epdriver_DrawChar(Result<void>, ImageBuffer, PointCoordinates, std::string, Fontype, ImageColor, ImageColor) = 0;
